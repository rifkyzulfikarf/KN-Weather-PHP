...
INNER JOIN `pemakai` ON `akses`.`id_pemakai` = `pemakai`.`id` WHERE `pemakai`.`id` = '$id_user' AND `akses_menu`.`level` = '$level' 
AND `akses_menu`.`induk`='$induk' ORDER BY `akses_menu`.`urutan`")) {
